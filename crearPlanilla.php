...
<head>
	...
	<script> 
		...
		function sumarc2() { 
			...
			document.consensuada.campo11c.value=n3+n4+n9; 
		} 
		...
		function sumar2(aux) { 
			...
			document.getElementById("campo11"+aux).value=n3+n4+n9;; 
		} 
		...
		<?php
			...
			if(isset($_GET['id_queso'])){
				...
				$campos = mysqli_query($con,"select campo1,campo2,campo3,campo4,campo5,campo6,campo7,campo8,campo9,campo10
					...
					//echo $punt[3];
					echo "<form name='consensuada' action='guarda_datos_planilla.php' method='POST'>";
					...
					echo "<tr>
						...
						/*echo "<tr>
								<td><input type='number' step='0.5' max=15 min=0 id='campo11c' name='campo11c onClick='this.select();'' onfocus='sumarc2()' required /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=30 min=0 id='campo12c' name='campo12c onClick='this.select();'' onfocus='sumarc3()' required /></td>
							</tr>";*/
							echo "<tr><td></td><td></td></tr>";	
						echo "<tr>
						...
						/*echo "<tr>
								<td><input type='number' step='0.5' max=30 min=0 id='campo29c' name='campo29c onClick='this.select();'' onfocus='sumarc5()' required /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=200 min=0 id='campo30c' name='campo30 onClick='this.select();'c' onfocus='sumarc6()' required /></td>
							</tr>";*/
					 echo "</table>";	
