		...
		<?php
			...
			if(isset($_GET['id_queso'])){
				...
				$campos = mysqli_query($con,"select campo1,campo2,campo3,campo4,campo5,campo6,campo7,campo8,campo9,campo10
					...
					$punt_consensuada = mysqli_query($con, "select * from puntaje where id_mesa=".$id_mesa." and id_queso=".$_GET['id_queso']." and id_jurado=1");
					...
					echo "<tr><td></td><td></td></tr>";
					echo "<tr>
							<td><input type='number' step='0.5' max=5 min=0 id='campo1c' name='campo1c' onClick='this.select();' onChange='sumarc1()' value=".$punt_c[3]."  required /></td>
							<td><input type='text' name='obs1c' value='".$punt_c[51]."' /></td>
						</tr>";	
					echo "<tr>
							<td><input type='number' step='0.5' max=5 min=0 id='campo2c' name='campo2c' onClick='this.select();' onChange='sumarc1()' value=".$punt_c[4]." required /></td>
							<td><input type='text' name='obs2c' value='".$punt_c[52]."' /></td>
						</tr>";
						/*echo "<tr>
								<td><input type='number' step='0.5' max=10 min=0 id='campo3c' name='campo3c onClick='this.select();'' onLoad='sumarc1()' required /></td>
							</tr>";	*/	

					echo "<tr><td></td><td></td></tr>";								

						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo4c' name='campo4c' onClick='this.select();' value=".$punt_c[5]." required /></td>
								<td><input type='text' name='obs3c' value='".$punt_c[53]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo5c' name='campo5c' onClick='this.select();' value=".$punt_c[6]." required /></td>
								<td><input type='text' name='obs4c' value='".$punt_c[54]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo6c' name='campo6c' onClick='this.select();' value=".$punt_c[7]." required /></td>
								<td><input type='text' name='obs5c' value='".$punt_c[55]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo7c' name='campo7c' onClick='this.select();' value=".$punt_c[8]." required /></td>
								<td><input type='text' name='obs6c' value='".$punt_c[56]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo8c' name='campo8c' onClick='this.select();' value=".$punt_c[9]." required /></td>
								<td><input type='text' name='obs7c' value='".$punt_c[57]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo9c' name='campo9c' onClick='this.select();' value=".$punt_c[10]." required /></td>
								<td><input type='text' name='obs8c' value='".$punt_c[58]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo10c' name='campo10c' onClick='this.select();' value=".$punt_c[11]." required /></td>
								<td><input type='text' name='obs9c' value='".$punt_c[59]."' /></td>
							</tr>";

						/*echo "<tr>
								<td><input type='number' step='0.1' max=15 min=0 id='campo11c' name='campo11c onClick='this.select();'' onfocus='sumarc2()' required /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.1' max=30 min=0 id='campo12c' name='campo12c onClick='this.select();'' onfocus='sumarc3()' required /></td>
							</tr>";*/

							echo "<tr><td></td><td></td></tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo13c' name='campo13c' onClick='this.select();' value=".$punt_c[12]." required /></td>
								<td><input type='text' name='obs10c' value='".$punt_c[60]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo14c' name='campo14c' onClick='this.select();' value=".$punt_c[13]." required /></td>
								<td><input type='text' name='obs11c' value='".$punt_c[61]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo15c' name='campo15c' onClick='this.select();' value=".$punt_c[14]." required /></td>
								<td><input type='text' name='obs12c' value='".$punt_c[62]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo16c' name='campo16c' onClick='this.select();' value=".$punt_c[15]." required /></td>
								<td><input type='text' name='obs13c' value='".$punt_c[63]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo17c' name='campo17c' onClick='this.select();' value=".$punt_c[16]." required /></td>
								<td><input type='text' name='obs14c' value='".$punt_c[64]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo18c' name='campo18c' onClick='this.select();' value=".$punt_c[17]." required /></td>
								<td><input type='text' name='obs15c' value='".$punt_c[65]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo19c' name='campo19c' onClick='this.select();' value=".$punt_c[18]." required /></td>
								<td><input type='text' name='obs16c' value='".$punt_c[66]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo20c' name='campo20c' onClick='this.select();' value=".$punt_c[19]." required /></td>
								<td><input type='text' name='obs17c' value='".$punt_c[67]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo21c' name='campo21c' onClick='this.select();' value=".$punt_c[20]." required /></td>
								<td><input type='text' name='obs18c' value='".$punt_c[68]."' /></td>
							</tr>";

					/*echo "<tr>
								<td><input type='number' step='0.5' max=45 min=0 id='campo22c' name='campo22c onClick='this.select();'' onfocus='sumarc4()' required /></td>
							</tr>";*/

							echo "<tr><td></td><td></td></tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo23c' name='campo23c' onClick='this.select();' value=".$punt_c[21]." required /></td>
								<td><input type='text' name='obs19c' value='".$punt_c[69]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo24c' name='campo24c' onClick='this.select();' value=".$punt_c[22]." required /></td>
								<td><input type='text' name='obs20c' value='".$punt_c[70]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo25c' name='campo25c' onClick='this.select();' value=".$punt_c[23]." required /></td>
								<td><input type='text' name='obs21c' value='".$punt_c[71]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo26c' name='campo26c' onClick='this.select();' value=".$punt_c[24]." required /></td>
								<td><input type='text' name='obs22c' value='".$punt_c[72]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo27c' name='campo27c' onClick='this.select();' value=".$punt_c[25]." required /></td>
								<td><input type='text' name='obs23c' value='".$punt_c[73]."' /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo28c' name='campo28c' onClick='this.select();' value=".$punt_c[26]." required /></td>
					...
					while($jurado = mysqli_fetch_array($jurados)){
							...
							echo "<tr><td></td></tr>";
							echo "<tr>
									<td><input type='number' step='0.5' max=5 min=0 id='campo1".$aux."' name='campo1".$aux."' onClick='this.select();' value=".$punt_j[3]."  required autofocus /></td>
								</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo2".$aux."' name='campo2".$aux."' onClick='this.select();' value=".$punt_j[4]."  required /></td>
							</tr>";
							echo "<tr><td></td></tr>";
							/*echo "<tr><td><input type='number' step='0.5' max=10 min=0 id='campo3".$aux."' name='campo3".$aux." onClick='this.select();'' onfocus='sumar1(".$aux.")'  /></td></tr>";*/
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo4".$aux."' name='campo4".$aux."' onClick='this.select();' value=".$punt_j[5]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo5".$aux."' name='campo5".$aux."' onClick='this.select();' value=".$punt_j[6]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo6".$aux."' name='campo6".$aux."' onClick='this.select();' value=".$punt_j[7]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo7".$aux."' name='campo7".$aux."' onClick='this.select();' value=".$punt_j[8]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo8".$aux."' name='campo8".$aux."' onClick='this.select();' value=".$punt_j[9]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo9".$aux."' name='campo9".$aux."' onClick='this.select();' value=".$punt_j[10]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo10".$aux."' name='campo10".$aux."' onClick='this.select();' value=".$punt_j[11]." required /></td>
							</tr>";
							/*echo "<tr><td><input type='number' step='0.5' max=15 min=0 id='campo11".$aux."' name='campo11".$aux." onClick='this.select();'' value='0' onfocus='sumar2(".$aux.")'  /></td></tr>";
							echo "<tr><td><input type='number' step='0.5' max=30 min=0 id='campo12".$aux."' name='campo12".$aux." onClick='this.select();'' value='0' onfocus='sumar3(".$aux.")'  /></td></tr>";*/
							echo "<tr><td></td></tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo13".$aux."' name='campo13".$aux."' onClick='this.select();' value=".$punt_j[12]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo14".$aux."' name='campo14".$aux."' onClick='this.select();' value=".$punt_j[13]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo15".$aux."' name='campo15".$aux."' onClick='this.select();' value=".$punt_j[14]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo16".$aux."' name='campo16".$aux."' onClick='this.select();' value=".$punt_j[15]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo17".$aux."' name='campo17".$aux."' onClick='this.select();' value=".$punt_j[16]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo18".$aux."' name='campo18".$aux."' onClick='this.select();' value=".$punt_j[17]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo19".$aux."' name='campo19".$aux."' onClick='this.select();' value=".$punt_j[18]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo20".$aux."' name='campo20".$aux."' onClick='this.select();' value=".$punt_j[19]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo21".$aux."' name='campo21".$aux."' onClick='this.select();' value=".$punt_j[20]." required /></td>
							</tr>";
							echo "<tr><td></td></tr>";
							//*echo "<tr><td><input type='number' step='0.5' max=45 min=0 id='campo22".$aux."' name='campo22".$aux." onClick='this.select();'' value='0' onfocus='sumar4(".$aux.")'  /></td></tr>";*/
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo23".$aux."' name='campo23".$aux."' onClick='this.select();' value=".$punt_j[21]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo24".$aux."' name='campo24".$aux."' onClick='this.select();' value=".$punt_j[22]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo25".$aux."' name='campo25".$aux."' onClick='this.select();' value=".$punt_j[23]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo26".$aux."' name='campo26".$aux."' onClick='this.select();' value=".$punt_j[24]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo27".$aux."' name='campo27".$aux."' onClick='this.select();' value=".$punt_j[25]." required /></td>
							</tr>";
							echo "<tr>
								<td><input type='number' step='0.5' max=5 min=0 id='campo28".$aux."' name='campo28".$aux."' onClick='this.select();' value=".$punt_j[26]." required /></td>
							</tr>";
