			...
			if(isset($_GET['id_queso'])){
				...
				$campos = mysqli_query($con,"select campo1,campo2,campo3,campo4,campo5,campo6,campo7,campo8,campo9,campo10
					...
					echo "<tr>
						...
						/*echo "<tr>
								<td><input type='number' step='0.5' max=15 min=0 id='campo11c' name='campo11c' onfocus='sumarc2()' required /></td>
							</tr>";
						echo "<tr>
								<td><input type='number' step='0.5' max=30 min=0 id='campo12c' name='campo12c' onfocus='sumarc3()' required /></td>
							</tr>";*/
						echo "<tr>
						...
						echo "<tr>
								<td><input type='number' step='0.5' max=200 min=0 id='campo30c' name='campo30c' onfocus='sumarc6()' required /></td>
							</tr>";*/
					 echo "</table>";	
