	...
	<div id="content">
		...
		<?php
			...
			*/
			...
			/*$sql= "select campo1, ae_1, ae_2,(ae_1+ae_2) as 'STAE',ai_1, ai_2, ai_3, ai_4, ai_5,ai_6, ai_7
				  ,(ai_1+ai_2+ai_3+ai_4+ai_5+ai_6+ai_7) as 'STAI'
				  ,(ae_1+ae_2+ai_1+ai_2+ai_3+ai_4+ai_5+ai_6+ai_7) 'Total Apariencia'
				  ,flavor_1,flavor_2, flavor_3, flavor_4, flavor_5, flavor_6, flavor_7, flavor_8, flavor_9
				  ...
				  ,t.descripcion_tipo 'queso', q.codigo_queso
				  from puntaje p inner join queso q on (p.id_queso = q.id_queso)
				  inner join tipo t on (t.id_tipo = q.id_tipo_queso)
				  where p.id_mesa =".$id_mesa." and p.id_queso=".$_GET['id_queso']." and p.id_jurado=".$_SESSION['id_jurado'];*/

			$sql= "select nombre_jurado,ae_1 'c1', ae_2 'c2',(ae_1+ae_2) as 'STAE',ai_1 'c3', ai_2 'c4', ai_3 'c5', ai_4 'c6'
				  , ai_5 'c7',ai_6 'c8', ai_7 'c9'
				  ,round((ai_1+((ai_2+ai_3+ai_4+ai_5+ai_6)/5)+ai_7),2) as 'STAI'
				  ,(ae_1+ae_2+ai_1+ai_2+ai_3+ai_4+ai_5+ai_6+ai_7) 'Total Apariencia'
				  ...
				  ,(textura_1+textura_2+textura_3+textura_4+textura_5+textura_6)'Total Textura'
				  ,(ae_1+ae_2+ai_1+ai_2+ai_3+ai_4+ai_5+ai_6+ai_7+flavor_1+flavor_2+flavor_3+flavor_4+flavor_5+flavor_6+flavor_7+flavor_8+flavor_9
				  	+textura_1+textura_2+textura_3+textura_4+textura_5+textura_6)
					,j.id_jurado
				  from puntaje p 
			...
			$campos = mysqli_query($con,"select campo1,campo2,campo3,campo4,campo5,campo6,campo7,campo8,campo9,campo10
					...
					echo "<table id='tpuntajes'>";
						...
						echo "<tr><td>".$res2[27]."</td></tr>";
						echo "<tr><td>".$res2[28]."</td></tr>";
						//echo "<tr><td>".$res2[29]."</td></tr>";
						//echo "<tr><td>".$res2[30]."</td></tr>";
					echo "</table>";	
